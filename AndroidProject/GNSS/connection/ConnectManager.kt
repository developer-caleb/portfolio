...
class ConnectManager private constructor() {
    ...
    private val mConnectionCallback: IConnectionCallback = object : IConnectionCallback {
        override fun backConnectionState(success: Boolean) {
            ...
            if (success) connectionStateChangeListener.onConnectStateChange(ConnectionStatus.CONNECTED)
            else connectionStateChangeListener.onConnectStateChange(ConnectionStatus.CONNECT_FAILD)
            if (success) {
