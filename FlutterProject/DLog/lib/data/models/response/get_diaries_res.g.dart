...
_$_GetDiariesRes _$$_GetDiariesResFromJson(Map<String, dynamic> json) =>
    _$_GetDiariesRes(
      data: json['data'] == null
          ? null
...
Map<String, dynamic> _$$_GetDiariesResToJson(_$_GetDiariesRes instance) =>
    <String, dynamic>{
      'data': instance.data,
...
_$_DataDto _$$_DataDtoFromJson(Map<String, dynamic> json) => _$_DataDto(
      ...
      list: (json['list'] as List<dynamic>?)
          ?.map((e) => DiaryModelRes.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
