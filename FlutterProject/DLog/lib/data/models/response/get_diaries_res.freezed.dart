...
GetDiariesRes _$GetDiariesResFromJson(Map<String, dynamic> json) {
  return _GetDiariesRes.fromJson(json);
}

/// @nodoc
mixin _$GetDiariesRes {
  DataDto? get data => throw _privateConstructorUsedError;
  ResultDto? get result => throw _privateConstructorUsedError;

  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $GetDiariesResCopyWith<GetDiariesRes> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GetDiariesResCopyWith<$Res> {
  factory $GetDiariesResCopyWith(
          GetDiariesRes value, $Res Function(GetDiariesRes) then) =
      _$GetDiariesResCopyWithImpl<$Res>;
...
/// @nodoc
class _$GetDiariesResCopyWithImpl<$Res>
    implements $GetDiariesResCopyWith<$Res> {
  _$GetDiariesResCopyWithImpl(this._value, this._then);

  final GetDiariesRes _value;
  // ignore: unused_field
  final $Res Function(GetDiariesRes) _then;
...
/// @nodoc
abstract class _$$_GetDiariesResCopyWith<$Res>
    implements $GetDiariesResCopyWith<$Res> {
  factory _$$_GetDiariesResCopyWith(
          _$_GetDiariesRes value, $Res Function(_$_GetDiariesRes) then) =
      __$$_GetDiariesResCopyWithImpl<$Res>;
  @override
  $Res call({DataDto? data, ResultDto? result});
...
/// @nodoc
class __$$_GetDiariesResCopyWithImpl<$Res>
    extends _$GetDiariesResCopyWithImpl<$Res>
    implements _$$_GetDiariesResCopyWith<$Res> {
  __$$_GetDiariesResCopyWithImpl(
      _$_GetDiariesRes _value, $Res Function(_$_GetDiariesRes) _then)
      : super(_value, (v) => _then(v as _$_GetDiariesRes));

  @override
  _$_GetDiariesRes get _value => super._value as _$_GetDiariesRes;
...
/// @nodoc
@JsonSerializable()
class _$_GetDiariesRes implements _GetDiariesRes {
  const _$_GetDiariesRes({this.data, this.result});

  factory _$_GetDiariesRes.fromJson(Map<String, dynamic> json) =>
      _$$_GetDiariesResFromJson(json);
  ...
  @override
  String toString() {
    return 'GetDiariesRes(data: $data, result: $result)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  _$$_GetDiariesResCopyWith<_$_GetDiariesRes> get copyWith =>
      __$$_GetDiariesResCopyWithImpl<_$_GetDiariesRes>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_GetDiariesResToJson(this);
  }
}

abstract class _GetDiariesRes implements GetDiariesRes {
  const factory _GetDiariesRes({final DataDto? data, final ResultDto? result}) =
      _$_GetDiariesRes;

  factory _GetDiariesRes.fromJson(Map<String, dynamic> json) =
      _$_GetDiariesRes.fromJson;
...
mixin _$DataDto {
  ...
  List<DiaryModelRes>? get list => throw _privateConstructorUsedError;
...
abstract class $DataDtoCopyWith<$Res> {
  ...
  $Res call({int? total, List<DiaryModelRes>? list});
}
...
class _$_DataDto implements _DataDto {
  const _$_DataDto({this.total, final List<DiaryModelRes>? list})
      : _list = list;
  ...
  @override
  final int? total;
  final List<DiaryModelRes>? _list;
  @override
  List<DiaryModelRes>? get list {
    final value = _list;
...
abstract class _DataDto implements DataDto {
  const factory _DataDto({final int? total, final List<DiaryModelRes>? list}) =
      _$_DataDto;
