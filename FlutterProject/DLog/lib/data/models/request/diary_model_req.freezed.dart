...
DiaryModelReq _$DiaryModelReqFromJson(Map<String, dynamic> json) {
  return _DiaryModelReq.fromJson(json);
}

/// @nodoc
mixin _$DiaryModelReq {
  ...
  @JsonKey(ignore: true)
  $DiaryModelReqCopyWith<DiaryModelReq> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DiaryModelReqCopyWith<$Res> {
  factory $DiaryModelReqCopyWith(
          DiaryModelReq value, $Res Function(DiaryModelReq) then) =
      _$DiaryModelReqCopyWithImpl<$Res>;
  $Res call(
      {int diaryVolumeSeq,
      int userSeq,
      int? diarySeq,
...
/// @nodoc
class _$DiaryModelReqCopyWithImpl<$Res>
    implements $DiaryModelReqCopyWith<$Res> {
  _$DiaryModelReqCopyWithImpl(this._value, this._then);

  final DiaryModelReq _value;
  // ignore: unused_field
  final $Res Function(DiaryModelReq) _then;
...
/// @nodoc
abstract class _$$_DiaryModelReqCopyWith<$Res>
    implements $DiaryModelReqCopyWith<$Res> {
  factory _$$_DiaryModelReqCopyWith(
          _$_DiaryModelReq value, $Res Function(_$_DiaryModelReq) then) =
      __$$_DiaryModelReqCopyWithImpl<$Res>;
  @override
  $Res call(
      {int diaryVolumeSeq,
      int userSeq,
...
/// @nodoc
class __$$_DiaryModelReqCopyWithImpl<$Res>
    extends _$DiaryModelReqCopyWithImpl<$Res>
    implements _$$_DiaryModelReqCopyWith<$Res> {
  __$$_DiaryModelReqCopyWithImpl(
      _$_DiaryModelReq _value, $Res Function(_$_DiaryModelReq) _then)
      : super(_value, (v) => _then(v as _$_DiaryModelReq));

  @override
  _$_DiaryModelReq get _value => super._value as _$_DiaryModelReq;
...
/// @nodoc
@JsonSerializable()
class _$_DiaryModelReq implements _DiaryModelReq {
  const _$_DiaryModelReq(
      ...
      this.emotion = '감정',
      this.weather = '날씨',
      required this.diaryResource,
      required this.diaryGps});

  factory _$_DiaryModelReq.fromJson(Map<String, dynamic> json) =>
      _$$_DiaryModelReqFromJson(json);
  ...
  @override
  String toString() {
    return 'DiaryModelReq(diaryVolumeSeq: $diaryVolumeSeq, userSeq: $userSeq, diarySeq: $diarySeq, dateTime: $dateTime, bodyText: $bodyText, emotion: $emotion, weather: $weather, diaryResource: $diaryResource, diaryGps: $diaryGps)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  _$$_DiaryModelReqCopyWith<_$_DiaryModelReq> get copyWith =>
      __$$_DiaryModelReqCopyWithImpl<_$_DiaryModelReq>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_DiaryModelReqToJson(this);
  }
}

abstract class _DiaryModelReq implements DiaryModelReq {
  const factory _DiaryModelReq(
      ...
      final String emotion,
      final String weather,
      required final DiaryResource diaryResource,
      required final DiaryGps diaryGps}) = _$_DiaryModelReq;

  factory _DiaryModelReq.fromJson(Map<String, dynamic> json) =
      _$_DiaryModelReq.fromJson;
...
mixin _$DiaryGps {
  ...
  String? get postTown => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      locality: locality == freezed
          ...
          : locality // ignore: cast_nullable_to_non_nullable
              as String?,
      postTown: postTown == freezed
          ? _value.postTown
          : postTown // ignore: cast_nullable_to_non_nullable
              as String?,
...
class _$_DiaryGps implements _DiaryGps {
  ...
  @override
  String toString() {
    return 'DiaryGps(name: $name, fsqId: $fsqId, address: $address, country: $country, locality: $locality, postTown: $postTown, postCode: $postCode, region: $region, geocode: $geocode, categoryList: $categoryList)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other.postTown, postTown) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(postTown),
...
abstract class $CategoryCopyWith<$Res> {
  ...
  $Res call({String? fsqId, String? id, String? name, String? icon});
}
...
class _$_Category implements _Category {
  const _$_Category(
      {this.fsqId = '', this.id = '', this.name = '', this.icon = ''});
  ...
  @override
  String toString() {
    return 'Category(fsqId: $fsqId, id: $id, name: $name, icon: $icon)';
  }
