...
class EventDetailNormalScreen extends StatefulWidget {
  const EventDetailNormalScreen({Key? key}) : super(key: key);

  @override
  State<EventDetailNormalScreen> createState() => _EventDetailNormalScreenState();
}

class _EventDetailNormalScreenState extends State<EventDetailNormalScreen> {
